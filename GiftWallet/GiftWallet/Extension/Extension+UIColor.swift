...
extension UIColor {
    ...
    static let kakaoButtonContainerGuide = UIColor(r: 254, g: 229, b: 0)
    static let kakaoButtonSymbolGuide = UIColor(r: 0, g: 0, b: 0)
    static let kakaoButtonLabelGuide = UIColor(r: 0, g: 0, b: 0, alpha: 0.85)
}
